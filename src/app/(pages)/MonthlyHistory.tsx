...
export default function MonthlyHistory() {
    ...
    const formatCurrency = (amount: number) => {
        const locale = currency === "INR" ? "en-IN" : currency === "USD" ? "en-US" : "en-IE";
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <View>
                    ...
                    <Text style={styles.headerSubtitle}>Snapshot of earnings, expenses & repayments</Text>
                </View>
                <TouchableOpacity
                            ...
                            <View key={month.month} style={styles.historyCard}>
                                ...
                                >
                                    <View style={styles.headerLeft}>
                                        ...
                                        <View>
                                            ...
                                            <Text style={styles.workCountSubText}>
                                                {month.workCount} work {month.workCount === 1 ? "entry" : "entries"}
                                            </Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={styles.headerRight}>
                                        ...
                                        <Text style={styles.netVal}>{formatCurrency(netAfterExpenses)}</Text>
                                    </View>
                                </LinearGradient>
                                ...
                                <View style={styles.statsGrid}>
                                    ...
                                    <View style={styles.statCell}>
                                        ...
                                        <Text style={styles.statVal}>{formatCurrency(month.expectedEarnings)}</Text>
                                    ...
                                    <View style={styles.statCell}>
                                        ...
                                        <Text style={styles.statSubText}>
                                            {month.expenseCount} record{month.expenseCount !== 1 ? "s" : ""}
                                        </Text>
                                    </View>
                                    ...
                                    <View style={styles.statCell}>
                                        <View style={styles.labelRow}>
                                            <Ionicons name="trending-down-outline" size={12} color="#64748b" />
                                        ...
                                        <Text style={styles.statSubText}>
                                            {month.repaymentCount} payment{month.repaymentCount !== 1 ? "s" : ""}
                                        </Text>
                                    </View>
                                </View>
                            </View>
