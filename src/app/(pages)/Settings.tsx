...
export default function Settings() {
    ...
    const [monthlyGoal, setMonthlyGoal] = useState(String(user?.monthlyGoal || 50000));
    ...
    const handleSaveProfile = async () => {
        ...
        if (isNaN(Number(monthlyGoal)) || Number(monthlyGoal) <= 0) {
            Alert.alert("Validation Error", "Please enter a valid monthly goal amount.");
            return;
        }
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <View>
                    ...
                    <Text style={styles.headerSubtitle}>Manage your profile and app preferences</Text>
                </View>
                <TouchableOpacity
                ...
                <View style={styles.card}>
                    ...
                    >
                        ...
                        <View>
                            ...
                            <Text style={styles.cardHeaderSubtitle}>Set your monthly earnings target</Text>
                        </View>
                    </LinearGradient>
                    ...
                    <View style={styles.cardBody}>
                        ...
                        <Text style={styles.helpText}>
                            This target determines the visual progress indicator on your dashboard.
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.card}>
                    ...
                    >
                        ...
                        <View>
                            ...
                            <Text style={styles.cardHeaderSubtitle}>Appearance and application theme</Text>
                        </View>
                    </LinearGradient>
                ...
                <View style={styles.card}>
                    ...
                    >
                        ...
                        <View>
                            ...
                            <Text style={styles.cardHeaderSubtitle}>Update your authentication credentials</Text>
                        </View>
                    </LinearGradient>
                    ...
                    <View style={styles.cardBody}>
                        ...
                        <TouchableOpacity
                            style={[styles.submitBtn, { backgroundColor: "#dc2626", marginTop: 12 }]}
