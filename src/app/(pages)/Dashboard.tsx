...
export default function Dashboard() {
  ...
  const goalProgress = Math.min(
    (summary.totalEarnedThisMonth / monthlyGoal) * 100,
    100,
  );
  const loanProgress =
    summary.totalLoanGoal > 0
      ? (summary.totalLoanPaid / summary.totalLoanGoal) * 100
      : 0;
        ...
        >
          ...
          <View style={styles.metricsGrid}>
            ...
            <MetricTile
              ...
              subtextColor={
                summary.netIncomeThisMonth >= 0 ? "success" : "error"
              }
            ...
            <MetricTile
              ...
              subtextColor={
                summary.totalLoanBalance === 0 ? "success" : "error"
              }
              icon="wallet-outline"
              gradientFrom="#7f1d1d"
              gradientTo="#ef4444"
            ...
            <MetricTile
              ...
              subtext={
                summary.totalRepaidThisMonth > 0
                  ? "Great progress!"
                  : "No repayments yet"
              }
              subtextColor="primary"
